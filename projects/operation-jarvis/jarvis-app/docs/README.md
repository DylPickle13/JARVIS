...
|---|---|
| [Development history](development-history.md) | The former app README: build notes, architecture contracts, operations, diagnostics, and historical plans. |
...
[Read the keyboard and native-attachment implementation history](implementation-history.md#iphone-terminal-keyboard-avoidance-and-native-attach-implementation-plan).

### JARVIS App Pi Attachment Integration Plan

[Read the attachment product contract](implementation-history.md#jarvis-app-pi-attachment-integration-plan).

# Native app development history

> **Archive, not a current operating procedure.** This preserves the former app
> README, including superseded plans and conflicting historical status claims.
> Statements such as "current", "installed", "not deployed", and "canonical"
> below refer to their original checkpoints, not to the present deployment.
> Commands, identifiers, device selections, and signing procedures require fresh
> owner verification before use. This archive is not deployment authorization.

Start with the [app overview](../README.md), [architecture](architecture.md),
[operations](operations.md), and [pending-work register](planned-work.md).
The original content is retained below; only Markdown links to the relocated
implementation notes have been adjusted.
...
[earlier six-session implementation contract](implementation-history.md#six-fixed-mobile-pi-conversations);
...
[`docs/README.md` implementation documentation](implementation-history.md#iphone-terminal-keyboard-avoidance-and-native-attach-implementation-plan).
...
attachment plans are in [`docs/README.md`](implementation-history.md). The
